...
final class DefaultNpmRunner extends NodeTaskExecutor implements NpmRunner {
    ...
    public DefaultNpmRunner(Platform platform, File workingDirectory, ProxyConfig proxyConfig) {
        super(TASK_NAME, TASK_LOCATION, workingDirectory, platform, Arrays.asList("--color=false"), proxyConfig);
    }
}
